...
public class Profile_page extends AppCompatActivity {
    TextView name1,email1,tv1,tv3,tv4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor2 = database.counta(email);
        if (cursor2.getCount()==0){
            Toast.makeText(Profile_page.this, "Nothing here", Toast.LENGTH_SHORT).show();
        }

        while(cursor2.moveToNext()){
            tv4.setText(cursor2.getString(0));
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mAuth.signOut();
                Intent intent = new Intent(Profile_page.this,Login.class);
