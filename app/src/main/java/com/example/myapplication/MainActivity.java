...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            // Extract the string value using the key "type"
        ...
        buttonchatgpt = (Button)findViewById(R.id.chatgpt);
        Intent chatgptintent = new Intent(MainActivity.this,ChatGPT.class);
        ...
        pic1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                adopt.setOnClickListener(new View.OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        boolean personExists = database.checkPersonExists(peta_id);
                        ...
                        if (personExists==false) {
                            ...
                            if (result1) {
                                Toast.makeText(MainActivity.this, "Congrats you adopted a pet!", Toast.LENGTH_SHORT).show();
                                Cursor c1 = database.getowner(peta_id);
                                if (c1.moveToFirst()) {
                                    oname = c1.getString(c1.getColumnIndex("name"));
                                    oemail = c1.getString(c1.getColumnIndex("email"));


                                }
                                AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity.this);
                                builder.setTitle("Please Contact the Owner");

                                builder.setMessage("Name: " + oname + "\nEmail: " + oemail);
                            ...
                            Toast.makeText(MainActivity.this, "Pet has been Adopted Already!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
...
//                    Toast.makeText(MainActivity.this, "Nothing here", Toast.LENGTH_SHORT).show();
        ...
        fetchUserDetails(type1,new UserDetailsCallback() {
            @Override
...
//        });
//    }
private void fetchUserDetails(String signInMethod, UserDetailsCallback callback) {
    ...
    // Handle other sign-in methods here if needed
}
